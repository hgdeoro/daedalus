...
#
# DAEDALUS_ENABLED_SUBSYSTEMS. Valid values:
#  - backend
#  - frontend
#  - both
#

DAEDALUS_ENABLED_SUBSYSTEMS = os.environ.get('DAEDALUS_ENABLED_SUBSYSTEMS', 'both')
assert DAEDALUS_ENABLED_SUBSYSTEMS in ('backend', 'frontend', 'both', )
...
CASSANDRA_CONNECTION_POOL_TIMEOUT = 2.0
...
DATABASES = {
    'default': {
        ...
        'NAME': join(DAEDALUS_DIR, 'daedalus.sqlite'),
        'USER': '',
        'PASSWORD': '',
        'HOST': '',
        'PORT': '',
...
SECRET_KEY = 'cephnagOpsOpDayGhiewtOocKurlyipMotshemBylkunbajegNifkeefres'
